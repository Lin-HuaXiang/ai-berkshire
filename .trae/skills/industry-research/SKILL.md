...
description: 行业产业链全景扫描。从投资主题出发，完成投资逻辑链验证、产业链全景图绘制、全球上市公司扫描、各环节头部公司四大师分析、行业级投资组合配置建议。当用户提到"行业研究"、"产业链"、"industry research"、"赛道分析"时使用。
...
**产业链扫描中的反偏见措施**：
1. 对每个环节，不仅列出"容易找到的公司"，还要主动搜索"冷门但可能优质的标的"
...
### 搜索策略
- 英文关键词：`{industry} public companies list`, `{industry} stocks by market cap`, `{industry} ETF holdings`
- 中文关键词：`{行业} 上市公司`, `{行业} 概念股`, `{行业} 龙头股`
- 日韩市场：`{industry} 日本 株式`, `{industry} 한국 주식`
...
### 4.5 估值快照
- 当前PE（市盈率）/PS（市销率）/EV（企业价值）/EBITDA（息税折旧摊销前利润）
- 与同环节竞争对手对比
- 简评：贵了/合理/便宜
...
6. 最终将完整报告写入 `reports/{行业英文}-industry-{YYYYMMDD}.md`
