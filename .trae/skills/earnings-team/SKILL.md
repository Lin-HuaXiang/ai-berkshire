---
name: earnings-team
description: 财报精读团队+公众号发布。四大师视角依次解读财报→Team Lead合成研究报告→编辑改写公众号文章→读者评审把关质量→定稿发布。当用户提到"财报团队"、"earnings team"、"财报发布"、"公众号财报"时使用。
tools: Read,Write,Bash,WebSearch,WebFetch
---

# 财报精读团队：四大师顺序解读 + 公众号发布

对 $ARGUMENTS 进行团队化财报精读分析。四位大师依次解读财报，编辑润色成文，读者评审把关质量，最终产出可直接发布的公众号文章。
...
本Skill的流程分三阶段，单Agent顺序执行：
- **阶段一·研究**：四大师依次精读财报（段永平看生意本质、巴菲特审财务质量、芒格读竞争变化、李录猎风险信号）
...
使用 WebSearch 和 WebFetch 获取以下原始材料：
...
2. **用户/客户价值变化**
   - DAU/MAU（日/月活跃用户）/付费用户等运营指标变化
   - 用户时长、ARPU（每用户平均收入）、留存率等质量指标
   - 平台/产品对用户的价值在增强还是减弱？
...
1. **核心财务数据提取与验证**
   - 收入、毛利、经营利润、净利润——GAAP（美国通用会计准则）和Non-GAAP（非美国通用会计准则）都要
...
全部四个视角分析完成后，Team Lead综合产出研究报告初稿。
...
| **`earnings-team`（本Skill）** | **四大师精读 + 公众号发布** | **重要公司的关键财报，需要深度+发布** |
| `investment-team` | 四大师全面公司研究 | 首次研究一家公司 |

## 关键原则

- **读原文，不读摘要**：尽一切可能获取一手资料
- **四个视角不是四个部门**：必须相互印证和挑战，不是各说各话
- **Team Lead的价值在于综合判断**：找交集和矛盾点，不是拼报告
